...
import 'src/login_via_apple_test.dart' as src__login_via_apple_test;
import 'src/login_via_email_and_password_test.dart'
    as src__login_via_email_and_password_test;
import 'src/login_via_google_test.dart' as src__login_via_google_test;
import 'src/logout_test.dart' as src__logout_test;
import 'src/sign_up_via_email_and_password_test.dart'
    as src__sign_up_via_email_and_password_test;
import 'src/switch_tenant_test.dart' as src__switch_tenant_test;
...
Future<void> main() async {
  ...
  group('src.login_via_apple_test', src__login_via_apple_test.main);
  group('src.login_via_email_and_password_test',
      src__login_via_email_and_password_test.main);
  group('src.login_via_google_test', src__login_via_google_test.main);
  group('src.logout_test', src__logout_test.main);
  group('src.sign_up_via_email_and_password_test',
      src__sign_up_via_email_and_password_test.main);
  group('src.switch_tenant_test', src__switch_tenant_test.main);
